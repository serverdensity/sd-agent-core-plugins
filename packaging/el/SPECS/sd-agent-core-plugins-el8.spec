...
%global        __sd_python_version 3.6
...
Requires: python36 >= 3.6, sysstat, libyaml
BuildRequires: symlinks, libffi-devel, python3-devel, openssl-devel, rrdtool-devel, postgresql-devel >= 9.1, libpq, libpq-devel
...
python3 virtualenv.py --no-site-packages --no-pip --no-setuptools %{__venv}
