...
MOCK_INFO = {'rra[6].cur_row': 556, 'rra[5].cdp_prep[0].value': 21262.533333333333,
'rra[6].pdp_per_row': 24, 'rra[7].cur_row': 795, 'ds[mem_buffers].value': 20376.0,
'rra[4].cdp_prep[0].unknown_datapoints': 0, 'rra[3].cdp_prep[0].unknown_datapoints': 177,
'rra[7].pdp_per_row': 288, 'rra[1].xff': 0.5, 'rra[3].cur_row': 100,
'rra[3].cdp_prep[0].value': 83282.52, 'rra[2].cf': 'AVERAGE', 'rra[4].cur_row': 454,
'rra[2].cdp_prep[0].value': 83282.52, 'ds[mem_buffers].minimal_heartbeat': 600,
'rra[0].cdp_prep[0].unknown_datapoints': 0, 'rra[5].cdp_prep[0].unknown_datapoints': 0,
'ds[mem_buffers].type': 'GAUGE', 'rra[1].pdp_per_row': 6, 'rra[1].rows': 700, 'rra[3].rows': 797,
'rrd_version': '0003', 'rra[7].xff': 0.5, 'rra[6].rows': 775, 'filename': '/var/lib/cacti/rra/localhost_mem_buffers_3.rrd',
'rra[1].cf': 'AVERAGE', 'last_update': 1484061001, 'rra[5].rows': 700, 'rra[4].xff': 0.5,
'rra[0].cf': 'AVERAGE', 'ds[mem_buffers].index': 0, 'rra[4].cf': 'MAX', 'rra[3].pdp_per_row': 288,
'ds[mem_buffers].last_ds': '20376', 'rra[7].cdp_prep[0].value': 21262.533333333333, 'rra[2].xff': 0.5,
'ds[mem_buffers].unknown_sec': 0, 'rra[0].pdp_per_row': 1, 'rra[7].rows': 797, 'rra[0].cur_row': 42,
'rra[6].xff': 0.5, 'rra[4].pdp_per_row': 1, 'header_size': 2040, 'rra[5].pdp_per_row': 6, 'rra[7].cf': 'MAX',
'step': 300, 'rra[3].xff': 0.5, 'ds[mem_buffers].max': None, 'rra[6].cdp_prep[0].unknown_datapoints': 9,
'rra[4].cdp_prep[0].value': None, 'ds[mem_buffers].min': 0.0, 'rra[0].cdp_prep[0].value': None,
'rra[1].cdp_prep[0].value': 41644.66666666667, 'rra[1].cur_row': 234, 'rra[0].rows': 600,
'rra[6].cdp_prep[0].value': 21262.533333333333, 'rra[5].cur_row': 194, 'rra[4].rows': 600, 'rra[3].cf': 'AVERAGE',
'rra[0].xff': 0.5, 'rra[5].cf': 'MAX', 'rra[2].cdp_prep[0].unknown_datapoints': 9, 'rra[5].xff': 0.5, 'rra[2].cur_row': 742,
'rra[6].cf': 'MAX', 'rra[7].cdp_prep[0].unknown_datapoints': 177, 'rra[1].cdp_prep[0].unknown_datapoints': 0, 'rra[2].rows': 775,
